...
int main()
{
    ...
    Shader lightingShader("../src/lighting/basicLighting/shaders/vertex1.vs", "../src/lighting/basicLighting/shaders/fragment1.fs");
    Shader lightCubeShader("../src/lighting/basicLighting/shaders/vertex1.vs", "../src/lighting/basicLighting/shaders/fragment2.fs");
